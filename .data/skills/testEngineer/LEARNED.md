...
<!-- AI writes here when user corrects generated test code -->

## Preferences

<!-- AI writes here when user states a testing preference -->

## Discovered Conventions

<!-- AI writes here when it discovers implicit test conventions through analysis -->
