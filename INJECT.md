...
- **Key dirs**: `src/skillnir/` (core package) · `.data/skills/` (source of truth) · `tests/` (pytest) · `.data/promptsv1/` (generation templates) · `src/skillnir/notifications/` (webhooks) · `scripts/` (CI runner)
