...
def _harness_research_cmd() -> None:
    """Search latest AI agent / LLM harness-engineering articles, summarize them, and generate a landing page."""
    import asyncio
    import webbrowser
    ...
    result = asyncio.run(
        harness_research(on_progress=on_progress, sources=source_choices or None)
    )
...
def main() -> None:
    ...
    if args.command == "install":
        ...
        _research_cmd()
    elif args.command == "harness-research":
        _harness_research_cmd()
